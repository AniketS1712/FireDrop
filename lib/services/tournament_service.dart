...
class TournamentService {
  ...
  Future<void> cancelTournament(TournamentModel tournament) async {
    if (tournament.status == TournamentStatus.completed) {
      throw Exception('Completed tournaments cannot be cancelled.');
    }

    await _repository.updateTournament(
      tournament.copyWith(status: TournamentStatus.cancelled),
    );
  }
  ...
  Future<void> updateRoomDetails(String tournamentId, RoomDetails? details) async {
